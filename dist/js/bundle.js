...
"use strict";
eval("\n\nvar apiKey = 'ec4010328c434b43a28619d8f4b0ac83';\nvar baseURL = 'https://newsapi.org/v2/';\nvar errorMessage = '';\n\n//https://newsapi.org/v2/sources?language=en&apiKey=ec4010328c434b43a28619d8f4b0ac83\n\n/*\r\nlet url = 'https://newsapi.org/v2/sources?' +\r\n    'language=en&' +\r\n    'country=gb&' +\r\n    'apiKey=ec4010328c434b43a28619d8f4b0ac83';\r\nlet req = new Request(url);\r\nfetch(req)\r\n    .then(function(response) {\r\n        //console.log(response.json());\r\n    });\r\n\r\n\r\nvar url2 = 'https://newsapi.org/v2/everything?' +\r\n    'q=brexit&' +\r\n    'from=2018-10-29&' +\r\n    'sortBy=popularity&' +\r\n    'apiKey=ec4010328c434b43a28619d8f4b0ac83';\r\n\r\nvar req2 = new Request(url2);\r\n\r\nfetch(req2)\r\n    .then(function(response) {\r\n        //console.log(response.json());\r\n    });\r\n*/\n\nfunction getNews() {\n    fetch(baseURL + '/sources?language=en&country=gb&apiKey=' + apiKey).then(function (result) {\n        console.log(result.status);\n        /*\r\n                    if(result.status === 200) {\r\n                        return result.json();\r\n                    }*/\n\n        switch (result.status) {\n\n            case 200:\n                //return result.json();\n                //console.log('success');\n                errorMessage += 'success';\n                break;\n            case 400:\n                errorMessage += 'Bad Request, missing or misconfigured parameter';\n                break;\n            case 401:\n                errorMessage += 'Unauthorized. API key was missing from the request, or wasn\\'t correct';\n                console.log('Unauthorized. API key was missing from the request, or wasn\\'t correct');\n                break;\n            case 429:\n                errorMessage += 'Too Many Requests. There where too many requests within a window of time and have been rate limited. Please try again later.';\n                break;\n            case 500:\n                errorMessage += 'Temporary! Server Error. Something went wrong with the NewsApi servers. Try again later';\n                break;\n            default:\n        }\n    }).then(function (data) {\n        //console.log(data);\n        //data.map(id => console.log(id))\n    }).catch(function (error) {\n        console.log('hi');\n    });\n}\n\ngetNews();\nconsole.log(errorMessage);\n\n//# sourceURL=webpack:///./src/js/index.js?");
